...
curl -fL -o auracp.deb \
  "https://github.com/tapashdatta/auraCP/releases/download/v0.1.14/auracp_0.1.14_${ARCH}.deb"
...
curl -fL -o /tmp/auracp.deb "https://github.com/tapashdatta/auraCP/releases/download/v0.1.14/auracp_0.1.14_${ARCH}.deb" && \
