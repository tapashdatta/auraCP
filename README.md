...
- **Single transactional site pipeline** (`AURACP_USE_NEW_CREATOR=1`, v0.2.48 opt-in) — every
...
curl -fL -o /tmp/auracp.deb "https://github.com/tapashdatta/auraCP/releases/download/v0.2.48/auracp_0.2.48_${ARCH}.deb" && \
