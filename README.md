...
- **Single transactional site pipeline** (`AURACP_USE_NEW_CREATOR=1`, v0.2.56 opt-in) — every
...
curl -fL -o auracp.deb \
  "https://github.com/tapashdatta/auraCP/releases/download/v0.2.56/auracp_0.2.56_${ARCH}.deb"
...
curl -fL -o /tmp/auracp.deb "https://github.com/tapashdatta/auraCP/releases/download/v0.2.56/auracp_0.2.56_${ARCH}.deb" && \
...
- [docs/CLOUDPANEL-STUDY.md](docs/CLOUDPANEL-STUDY.md) — derivation of the v0.2.56 single-pipeline architecture
- [docs/V0.2.56-VALIDATION.md](docs/V0.2.56-VALIDATION.md) — checklist for the opt-in pipeline rollout
