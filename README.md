...
curl -fL -o auracp.deb \
  "https://github.com/tapashdatta/auraCP/releases/download/v0.2.44/auracp_0.2.44_${ARCH}.deb"
...
curl -fL -o /tmp/auracp.deb "https://github.com/tapashdatta/auraCP/releases/download/v0.2.44/auracp_0.2.44_${ARCH}.deb" && \
